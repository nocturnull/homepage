<template>
  <div class="work">
    <div class="work-intro">
      <h1 class="work-title">Heartware Korea</h1>
      <p class="work-description">Pig kevin prosciutto short loin pork belly tri-tip drumstick bacon picanha cupim capicola. Rump tenderloin ham, bacon turkey tail landjaeger.</p>
